        ...
        <form @submit.prevent="submit" style="width:100%; max-width:100%; min-width:0;">
            ...
            <div class="form-grid" style="width:100%; max-width:100%; min-width:0;">
                ...
                <div class="form-group">
                    ...
                    <input id="image_url" v-model="form.image_url" type="text" style="width:100%; max-width:100%; min-width:0; box-sizing:border-box;" />
                </div>
            </div>
            <div class="form-group">
                <label for="image">{{ t("admin.products.fields.image") }}</label>
                <input id="image" type="file" accept="image/*" @change="handleFileChange" style="width:100%; max-width:100%; min-width:0; box-sizing:border-box;" />
            </div>
