...
.form-group input { width:100%; max-width:100%; min-width:0; box-sizing:border-box; padding:8px; border-radius:6px; border:1px solid #ddd; font-family:inherit; font-size:14px; }
